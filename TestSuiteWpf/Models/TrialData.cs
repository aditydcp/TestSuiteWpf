...
namespace TestSuiteWpf.Models
{
    ...
    public class TrialData
    {
        ...
        /// </summary>
        public TrialData(Result result, int startScore, int endScore, DateTime startTime, DateTime endTime, Question question, int answer)
        {
            Result = result;
            ...
            Solution = question.Answer.ToString();
        ...
        /// </summary>
        public TrialData(Result result, int startScore, DateTime startTime, DateTime endTime, Question question, int answer)
        {
            Result = result;
            StartScore = startScore;
            StartTime = startTime;
        ...
        /// </summary>
        public TrialData(Result result, long reactionTime, int startScore, int endScore, DateTime startTime, DateTime endTime, Question question, int answer)
        {
            Result = result;
        ...
        /// <see cref="TrialData.Question"/>, <see cref="TrialData.Solution"/> and <see cref="TrialData.UserAnswer"/>.
        ...
        /// <param name="question">The question in <seealso cref="Models.Question"/> type</param>
        /// <param name="answer">The answer submitted by user</param>
        public void EnterData(Result result, int endScore, DateTime endTime, Question question, int answer)
        {
            Result = result;
            EndTime = endTime;
            EndScore = endScore;
